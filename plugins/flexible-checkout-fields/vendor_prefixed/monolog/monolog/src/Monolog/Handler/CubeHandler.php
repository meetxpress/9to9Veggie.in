 ...
 */
class CubeHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct($url, $level = \FcfVendor\Monolog\Logger::DEBUG, $bubble = \true)
    {
    ...
    protected function connectUdp()
    {
        if (!\extension_loaded('sockets')) {
            throw new \FcfVendor\Monolog\Handler\MissingExtensionException('The sockets extension is required to use udp URLs with the CubeHandler');
        }
    ...
    private function writeHttp($data)
    {
        ...
        \FcfVendor\Monolog\Handler\Curl\Util::execute($this->httpConnection, 5, \false);
    }
}
