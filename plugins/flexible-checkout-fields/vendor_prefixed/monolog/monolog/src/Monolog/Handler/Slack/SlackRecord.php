...
class SlackRecord
{
    ...
    public function __construct($channel = null, $username = null, $useAttachment = \true, $userIcon = null, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array(), \FcfVendor\Monolog\Formatter\FormatterInterface $formatter = null)
    {
        ...
        if ($this->includeContextAndExtra) {
            $this->normalizerFormatter = new \FcfVendor\Monolog\Formatter\NormalizerFormatter();
        }
    }
    ...
    {
        switch (\true) {
            case $level >= \FcfVendor\Monolog\Logger::ERROR:
                return self::COLOR_DANGER;
            case $level >= \FcfVendor\Monolog\Logger::WARNING:
                return self::COLOR_WARNING;
            case $level >= \FcfVendor\Monolog\Logger::INFO:
