 ...
 */
class SlackHandler extends \FcfVendor\Monolog\Handler\SocketHandler
{
    /**
     * Slack API token
     * @var string
     ...
     */
    public function __construct($token, $channel, $username = null, $useAttachment = \true, $iconEmoji = null, $level = \FcfVendor\Monolog\Logger::CRITICAL, $bubble = \true, $useShortAttachment = \false, $includeContextAndExtra = \false, array $excludeFields = array())
    {
        if (!\extension_loaded('openssl')) {
            throw new \FcfVendor\Monolog\Handler\MissingExtensionException('The OpenSSL PHP extension is required to use the SlackHandler');
        }
        parent::__construct('ssl://slack.com:443', $level, $bubble);
        $this->slackRecord = new \FcfVendor\Monolog\Handler\Slack\SlackRecord($channel, $username, $useAttachment, $iconEmoji, $useShortAttachment, $includeContextAndExtra, $excludeFields, $this->formatter);
        $this->token = $token;
    }
