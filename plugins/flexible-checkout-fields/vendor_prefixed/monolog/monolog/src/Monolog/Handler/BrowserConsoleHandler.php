 ...
 */
class BrowserConsoleHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \FcfVendor\Monolog\Formatter\LineFormatter('[[%channel%]]{macro: autolabel} [[%level_name%]]{font-weight: bold} %message%');
    }
    /**
     * {@inheritDoc}
     */
