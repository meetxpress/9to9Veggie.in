 ...
 */
class SlackbotHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($slackTeam, $token, $channel, $level = \FcfVendor\Monolog\Logger::CRITICAL, $bubble = \true)
    {
