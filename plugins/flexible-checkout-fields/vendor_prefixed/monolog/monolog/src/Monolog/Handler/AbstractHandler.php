 ...
 */
abstract class AbstractHandler implements \FcfVendor\Monolog\Handler\HandlerInterface, \FcfVendor\Monolog\ResettableInterface
{
    protected $level = \FcfVendor\Monolog\Logger::DEBUG;
