 ...
 */
class NewRelicHandler extends \FcfVendor\Monolog\Handler\AbstractProcessingHandler
{
    /**
     ...
     */
    public function __construct($level = \FcfVendor\Monolog\Logger::ERROR, $bubble = \true, $appName = null, $explodeArrays = \false, $transactionName = null)
    {
    ...
    protected function write(array $record)
    {
        if (!$this->isNewRelicEnabled()) {
            throw new \FcfVendor\Monolog\Handler\MissingExtensionException('The newrelic PHP extension is required to use the NewRelicHandler');
        }
