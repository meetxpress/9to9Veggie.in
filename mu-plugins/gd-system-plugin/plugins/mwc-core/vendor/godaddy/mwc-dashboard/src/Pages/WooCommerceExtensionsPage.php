 ...
 * @since x.y.z
 */
class WooCommerceExtensionsPage extends WordPressAdminPage
{
    ...
    public function __construct()
    {
        ...
        $this->pageTitle = __('WooCommerce extensions', 'mwc-dashboard');
     ...
     * @throws Exception
     */
    protected function registerMenuItem() : WordPressAdminPage
    {
        try {
