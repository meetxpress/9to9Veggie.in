...
class OrderTrackingEventsProducer implements ProducerContract
{
    ...
    /**
     * Sets up the Order tracking events producer.
     *
     * @throws Exception
     */
     ...
     * @throws Exception
     */
    public function maybeFireOrderTrackingInformationCreatedEvent($metaId, $objectId, $metaKey, $metaValue) : void
    {
     ...
     * @throws Exception
     */
    public function maybeFireOrderTrackingInformationUpdatedEvent($metaId, $objectId, $metaKey, $metaValue) : void
    {
        if ($metaKey !== '_wc_shipment_tracking_items' || ! $objectId) {
            return;
        }
     ...
     * @throws Exception
     */
    protected function fireOrderTrackingInformationEvent(AbstractOrderTrackingInformationEvent $event, int $orderId, array $trackingItems) : void
    {
